...
Generated: 2026-07-27T08:43:41.6783821+00:00
...
- [ ] Page `/Admin/PortalAdmin` — resource key: `ContentManagement`; source: `App/ContentManagement/Pages/Admin_PortalAdmin.json`
  - [ ] Component `CoreManagement` — Application; resource key: `ContentManagement`
    ...
    - [ ] Component `AppMigrator` — Application; resource key: `ContentManagement`
      ...
      - [ ] Component `ScriptRunner` — Common Cache; resource key: `Common`
        - Already expanded above
- [ ] Page `/Admin/Tenants` — resource key: `Security`; source: `App/Security/Pages/Admin_Tenants.json`
  - [ ] Resource token `tenants`
  - [ ] Resource token `roles`
